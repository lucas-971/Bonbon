...
<html lang="fr">
  ...
  <h1> Bonjour <?php echo $login ?></h1>
	...
	<form name="formulaire" action="modifier2.php" method="Get">
	...
	while($produit = $resultat->fetch(PDO::FETCH_OBJ))
	{
		...
		echo "
		  ...
		  <div class='card-body'>
            ...
            <a class='btn btn-primary' href='ajout_panier.php?sachet=$produit->id' role='button'>Ajouter au panier<i class='fas fa-edit'></i></a>
